...
public class VideoHomeAdapter extends RecyclerView.Adapter<VideoHomeAdapter.HomeHolder> implements View.OnClickListener {
    ...
    public VideoHomeAdapter(Context fragment, List<DataBean> mData, GridLayoutManager gridLayoutManager) {
    ...
    public HomeHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.video_item_recyview, parent, false);
