...
import com.lcgsen.utils.UrlUtil;
...
public class HomeFragment extends BaseFragment implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        // 如果是首页的话， 隐藏前三个按钮
        if (page.getVisibility() == View.GONE) {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.search_video:
                ...
                builder.setTitle("请输入电影关键字").setIcon(R.drawable.default_icon).setView(inputServer).setNegativeButton("取消", null);
                builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        requestUrl = "https://m.yiybb.com/search/?Key=" + UrlUtil.getURLEncoderString(inputServer.getText().toString());
                        initData();
                    }
                });
                builder.show();
